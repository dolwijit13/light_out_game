...
public class Light extends Button {
	...
	public Light(String text, int h, int w, int maxState, int mode, int level) {
		...
		case 0:
			// for classic
			state0 = new ImageView(new Image(
					ClassLoader.getSystemResource("assets/classic/" + level + "/" + text + ".png").toString()));
			state1 = new ImageView(
					new Image(ClassLoader.getSystemResource("assets/classic/back_light.png").toString()));
			break;
		case 1:
			// for timer
			color0 = "#444444";
