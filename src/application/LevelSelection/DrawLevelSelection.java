...
public class DrawLevelSelection extends LevelSelection {
	...
	protected void setLabelStyle(Label selectLabel) {
		selectLabel.setStyle("-fx-font-size: 48px; -fx-font-family:\"Arial Black\"; -fx-background-color: #2BCA2F;");
	...
	protected void setButtonStyle(Button levelButton, int mode) {
		if (mode == 0)
			levelButton.setStyle(
					"-fx-font-size: 36px; -fx-font-family:\"Arial Black\";-fx-fill: #555;-fx-background-color: #7BCA7D;");
		else
			levelButton.setStyle(
					"-fx-font-size: 36px; -fx-font-family:\"Arial Black\";-fx-fill: #555;-fx-background-color: #7BCA7D;-fx-border-color: #000000;-fx-border-width: 4px;");
	}
}
