...
public class ClassicLevelSelection extends LevelSelection {
	...
	protected void setLevelButton(LevelButton levelButton) {
	...
	protected void setLabelStyle(Label selectLabel) {
		selectLabel.setStyle("-fx-font-size: 48px; -fx-font-family:\"Arial Black\"; -fx-background-color: #FF4343;");
	...
	protected void setButtonStyle(Button levelButton, int mode) {
		if (mode == 0)
			levelButton.setStyle(
					"-fx-font-size: 36px; -fx-font-family:\"Arial Black\";-fx-fill: #555;-fx-background-color: #FF5959;");
		else
			levelButton.setStyle(
					"-fx-font-size: 36px; -fx-font-family:\"Arial Black\";-fx-fill: #555;-fx-background-color: #FF5959;-fx-border-color: #000000;-fx-border-width: 4px;");
	}
}
