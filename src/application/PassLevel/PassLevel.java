...
public abstract class PassLevel extends VBox {
	...
	public PassLevel(int mode, int level, int penalty, int maxLevel) {
		...
		if (mode == 0)
			backButton = new BackButton(100, 120, new ClassicLevelSelection(1));
		if (mode == 1)
			backButton = new BackButton(100, 120, new ModeSelection());
		if (mode == 2)
			backButton = new BackButton(100, 120, new DrawLevelSelection(1));
		if (mode == 3)
			backButton = new BackButton(100, 120, new TriColorLevelSelection(1));
