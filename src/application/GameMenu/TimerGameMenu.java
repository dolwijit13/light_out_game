...
public class TimerGameMenu extends GameMenu {
	...
	private Label passedLevelCountLabel;
	...
	public TimerGameMenu(int penalty, int level) {
		...
		passedLevelCountLabel = new Label("0");
		passedLevelCountLabel.setStyle("-fx-font-size: 24px; -fx-font-family:\"Arial Black\";");
		...
		passedLabelVBox.getChildren().addAll(passedLevelLabel, passedLevelCountLabel);
	...
	public void setPassedLevelLabel(int passedLevel) {
		passedLevelCountLabel.setText("" + passedLevel);
	}
